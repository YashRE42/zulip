...
run_test("filter_by_word_prefix_match_at_word_boundaries", () => {
    ...
    assert.deepEqual(
        util.filter_by_word_prefix_match_at_word_boundaries(streams, "under", stream_id_to_name),
        [1, 5],
    );
    assert.deepEqual(
        util.filter_by_word_prefix_match_at_word_boundaries(streams, "dash", stream_id_to_name),
        [2, 5],
    );
    assert.deepEqual(
        util.filter_by_word_prefix_match_at_word_boundaries(streams, "slash", stream_id_to_name),
        [3, 5],
    );
    assert.deepEqual(
        util.filter_by_word_prefix_match_at_word_boundaries(streams, "space", stream_id_to_name),
        [4, 5],
    );
    assert.deepEqual(
        util.filter_by_word_prefix_match_at_word_boundaries(streams, "stream-d", stream_id_to_name),
        [2],
    );
});
