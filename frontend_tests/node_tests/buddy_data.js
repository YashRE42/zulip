...
const {mock_esm, with_field_rewire, zrequire, set_global} = require("../zjsunit/namespace");
...
test("bulk_data_hacks", () => {
    ...
    with_field_rewire(buddy_data, "max_size_before_shrinking", 200, () => {
        user_keys = buddy_data.get_filtered_and_sorted_key_groups_and_titles("").user_keys;
    });
...
test("additional count", ({override_rewire}) => {
    ...
    with_field_rewire(buddy_data, "max_size_before_shrinking", 3, () => {
    ...
    with_field_rewire(buddy_data, "max_size_before_shrinking", 2, () => {
        key_groups_and_titles = buddy_data.get_filtered_and_sorted_key_groups_and_titles("");
    });
