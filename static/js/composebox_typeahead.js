    ...
    switch (this.completing) {
        ...
        case "silent_mention":
            ...
            if (user_groups.is_user_group(item)) {
                ...
                const mention_text = people.get_mention_syntax(item.full_name, item.user_id, true); // is_silent = true
        ...
        case "mention":
            ...
            if (user_groups.is_user_group(item)) {
                ...
                const mention_text = people.get_mention_syntax(item.full_name, item.user_id, false); // is_silent = false
                beginning += mention_text + " ";
            }
            break;
        case "slash":
