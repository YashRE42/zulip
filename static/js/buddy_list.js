...
class BuddyListConf {
    ...
    items_to_html(opts) {
        const html = render_presence_rows({row_members: opts.items});
        return html;
    }
...
export class BuddyList extends BuddyListConf {
    ...
    maybe_render_extra_users_count() {
    ...
    maybe_render_extra_others_count() {
    ...
    users_render_more(opts) {
        ...
        if (render_count > 0) {
            ...
            this.update_padding();
            this.maybe_render_extra_users_count();
        }
    }
    ...
    others_render_more(opts) {
        ...
        if (render_count > 0) {
            ...
            this.update_padding();
            this.maybe_render_extra_others_count();
        }
    }
